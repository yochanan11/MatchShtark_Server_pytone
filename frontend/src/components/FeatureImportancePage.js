        ...
        fetch("http://localhost:5000/api/model/importance-data")
            ...
            .then((json) => {
                if (Array.isArray(json)) {
                    ...
                    setData([]); // או תוכל להכניס הודעת שגיאה אם תרצה
                }
                setLoading(false);
            })
            .catch((error) => {
            ...
            <div style={{maxWidth: '1200px', margin: '0 auto', padding: '32px 16px'}}>
                ...
                <div style={{
                    ...
                    <div style={statCardStyle}>
                        ...
                        <div>
                            <h3 style={{fontSize: '18px', fontWeight: '600', color: '#1F2937', margin: 0}}>דיוק
                                המודל</h3>
                            <p style={{
                                fontSize: '24px',
                                fontWeight: 'bold',
                    ...
                    <div style={statCardStyle}>
                        ...
                        <div>
                            <h3 style={{fontSize: '18px', fontWeight: '600', color: '#1F2937', margin: 0}}>התאמות
                                מוצלחות</h3>
                            <p style={{
                                fontSize: '24px',
                                fontWeight: 'bold',
                    ...
                    <div style={statCardStyle}>
                        ...
                        <div>
                            <h3 style={{fontSize: '18px', fontWeight: '600', color: '#1F2937', margin: 0}}>מאפיינים
                                פעילים</h3>
                            <p style={{
                                fontSize: '24px',
                                fontWeight: 'bold',
